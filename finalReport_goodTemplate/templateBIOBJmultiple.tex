...
The algorithm input consists of decision space vectors $x^i \in X$, an objective space $Z$ and objective functions $f^j : X \rightarrow Z$.

\section{Description of algorithm}

The output of a MOEA is a set of incomparable decision vector, meaning that no member of the output set dominates another one. Domination between decision vectors is defined as follows:
...
\subsection{Additional details regarding mutation}

% https://www.iitk.ac.in/kangal/papers/k2012016.pdf

\subsection{Additional details regarding recombination}
